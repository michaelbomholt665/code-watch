...
project: code-watch
generated_at: 2026-02-21T00:35:56Z
version: 1.0.0
---
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `circular/cmd/circular` | `main` | `cmd/circular/main.go` | 1 | 0 | 0 | 0 | 0 |
| `circular/internal/core/app` | `*App` | `internal/core/app/app.go` | 1 | 0 | 0 | 0 | 0 |
| `circular/internal/core/app` | `AnalysisService` | `internal/core/app/service.go` | 1 | 0 | 0 | 0 | 0 |
| `circular/internal/core/app` | `AnalyzeHallucinations` | `internal/core/app/analyzer.go` | 1 | 0 | 0 | 0 | 0 |
| `circular/internal/core/app` | `AnalyzeHallucinationsIncremental` | `internal/core/app/analyzer.go` | 1 | 0 | 0 | 0 | 0 |
...
| Reference | Location |
| --- | --- |
| `a.detector.Detect` | `internal/engine/secrets/adapter.go:26:9` |
| `a.detector.Detect` | `internal/engine/secrets/adapter.go:31:10` |
...
| `graph.NewLayerRuleEngine` | `internal/core/app/presentation_service.go:23:15` |
| `helpers.ArchitectureModelFromConfig` | `internal/core/app/presentation_service.go:23:40` |
| `report.NewMermaidGenerator` | `internal/core/app/presentation_service.go:43:17` |
| `mermaidGen.SetModuleMetrics` | `internal/core/app/presentation_service.go:44:3` |
| `mermaidGen.SetComplexityHotspots` | `internal/core/app/presentation_service.go:45:3` |
| `helpers.ArchitectureModelFromConfig` | `internal/core/app/presentation_service.go:46:65` |
| `report.NewMarkdownGenerator().Generate` | `internal/core/app/presentation_service.go:56:13` |
| `report.NewMarkdownGenerator` | `internal/core/app/presentation_service.go:56:13` |
| `helpers.WriteArtifact` | `internal/core/app/presentation_service.go:96:13` |
| `helpers.MetricLeaders` | `internal/core/app/presentation_service.go:169:15` |
| `helpers.MetricLeaders` | `internal/core/app/presentation_service.go:170:15` |
| `helpers.MetricLeaders` | `internal/core/app/presentation_service.go:171:16` |
...
| `util.SortedStringKeys` | `internal/engine/parser/parser.go:141:9` |
...
| `c.order.Remove` | `internal/engine/graph/lru.go:147:2` |
| `sp.SetLanguage` | `internal/engine/parser/pool.go:36:4` |
| `sp.SetLanguage` | `internal/engine/parser/pool.go:48:2` |
...
| `w.watchRecursive` | `internal/core/watcher/watcher.go:115:13` |
| `info.IsDir` | `internal/core/watcher/watcher.go:130:6` |
| `w.shouldExcludeDir` | `internal/core/watcher/watcher.go:131:7` |
| `info.IsDir` | `internal/core/watcher/watcher.go:151:22` |
| `w.shouldExcludeDir` | `internal/core/watcher/watcher.go:152:10` |
| `w.watchRecursive` | `internal/core/watcher/watcher.go:153:17` |
| `w.shouldExcludeFile` | `internal/core/watcher/watcher.go:163:7` |
| `w.scheduleChange` | `internal/core/watcher/watcher.go:171:5` |
| `w.pendingMu.Lock` | `internal/core/watcher/watcher.go:184:2` |
| `w.pendingMu.Unlock` | `internal/core/watcher/watcher.go:185:8` |
| `w.timer.Stop` | `internal/core/watcher/watcher.go:190:3` |
| `w.pendingMu.Lock` | `internal/core/watcher/watcher.go:199:2` |
| `w.pendingMu.Unlock` | `internal/core/watcher/watcher.go:205:2` |
| `g.Match` | `internal/core/watcher/watcher.go:217:6` |
| `g.Match` | `internal/core/watcher/watcher.go:245:6` |
| `w.timer.Stop` | `internal/core/watcher/watcher.go:254:3` |
| `info.IsDir` | `internal/core/watcher/watcher.go:261:35` |
| `w.shouldExcludeFile` | `internal/core/watcher/watcher.go:264:6` |
| `w.scheduleChange` | `internal/core/watcher/watcher.go:267:3` |
...
| `g.findCycles` | `internal/engine/graph/detect.go:16:4` |
| `g.findCycles` | `internal/engine/graph/detect.go:44:4` |
| `g.mu.RLock` | `internal/engine/graph/detect.go:52:2` |
| `g.mu.RUnlock` | `internal/engine/graph/detect.go:53:8` |
| `g.mu.RLock` | `internal/engine/graph/detect.go:113:2` |
| `g.mu.RUnlock` | `internal/engine/graph/detect.go:114:8` |
...
| `a.Graph.GetModule` | `internal/core/app/reporting.go:16:14` |
| `a.Graph.GetModule` | `internal/core/app/reporting.go:19:14` |
| `b.WriteString` | `internal/core/app/reporting.go:29:2` |
| `b.WriteString` | `internal/core/app/reporting.go:31:3` |
| `b.WriteString` | `internal/core/app/reporting.go:32:3` |
| `b.WriteString` | `internal/core/app/reporting.go:34:4` |
| `b.String` | `internal/core/app/reporting.go:38:27` |
| `a.Graph.GetAllFiles` | `internal/core/app/reporting.go:55:23` |
| `a.Graph.GetAllFiles` | `internal/core/app/reporting.go:63:23` |
| `err.Error` | `internal/ui/cli/runtime.go:59:27` |
| `err.Error` | `internal/ui/cli/runtime.go:67:27` |
| `analysis.RunScan` | `internal/ui/cli/runtime.go:122:15` |
| `analysis.SyncOutputs` | `internal/ui/cli/runtime.go:146:15` |
| `analysis.WatchService` | `internal/ui/cli/runtime.go:201:11` |
| `err.Error` | `internal/ui/cli/runtime.go:231:28` |
| `err.Error` | `internal/ui/cli/runtime.go:241:28` |
| `analysis.QueryService` | `internal/ui/cli/runtime.go:260:9` |
| `err.Error` | `internal/ui/cli/runtime.go:271:28` |
| `err.Error` | `internal/ui/cli/runtime.go:287:28` |
| `err.Error` | `internal/ui/cli/runtime.go:292:28` |
| `err.Error` | `internal/ui/cli/runtime.go:304:28` |
| `err.Error` | `internal/ui/cli/runtime.go:309:28` |
| `err.Error` | `internal/ui/cli/runtime.go:328:28` |
| `config.Load` | `internal/ui/cli/runtime.go:347:15` |
| `config.Load` | `internal/ui/cli/runtime.go:361:19` |
| `config.ResolveRelative` | `internal/ui/cli/runtime.go:596:19` |
| `config.ResolveRelative` | `internal/ui/cli/runtime.go:604:34` |
| `config.ResolveRelative` | `internal/ui/cli/runtime.go:606:41` |
| `analysis.RunScan` | `internal/ui/cli/runtime.go:653:15` |
| `analysis.SyncOutputs` | `internal/ui/cli/runtime.go:658:16` |
...
| `g.BuildUniversalSymbolTable` | `internal/engine/resolver/resolver.go:83:17` |
| `g.BuildUniversalSymbolTable` | `internal/engine/resolver/resolver.go:106:17` |
| `r.resolveReferenceResult` | `internal/engine/resolver/resolver.go:127:12` |
| `r.isStdlibSymbol` | `internal/engine/resolver/resolver.go:152:5` |
| `r.isStdlibSymbol` | `internal/engine/resolver/resolver.go:264:9` |
| `a.Graph.DetectCycles` | `internal/core/app/output.go:23:19` |
| `a.AnalyzeHallucinations` | `internal/core/app/output.go:24:19` |
| `a.Graph.ModuleCount` | `internal/core/app/output.go:25:19` |
| `a.Graph.FileCount` | `internal/core/app/output.go:26:19` |
| `a.SecretCount` | `internal/core/app/output.go:27:19` |
| `helpers.ArchitectureModelFromConfig` | `internal/core/app/output.go:48:15` |
| `helpers.WriteArtifact` | `internal/core/app/output.go:68:13` |
| `a.AnalyzeProbableBridges` | `internal/core/app/output.go:81:22` |
| `helpers.WriteArtifact` | `internal/core/app/output.go:113:13` |
| `a.Config.Output.MermaidEnabled` | `internal/core/app/output.go:118:42` |
| `a.Config.Output.PlantUMLEnabled` | `internal/core/app/output.go:119:44` |
| `a.Config.Output.Report.IncludeMermaidEnabled` | `internal/core/app/output.go:120:31` |
| `a.Config.Output.MermaidEnabled` | `internal/core/app/output.go:120:81` |
| `a.Config.Output.MermaidEnabled` | `internal/core/app/output.go:126:7` |
| `a.Config.Output.PlantUMLEnabled` | `internal/core/app/output.go:130:7` |
| `report.NewMermaidGenerator` | `internal/core/app/output.go:137:17` |
| `mermaidGen.SetModuleMetrics` | `internal/core/app/output.go:138:3` |
| `mermaidGen.SetComplexityHotspots` | `internal/core/app/output.go:139:3` |
| `mode.Suffix` | `internal/core/app/output.go:143:59` |
| `helpers.DiagramOutputPath` | `internal/core/app/output.go:147:16` |
| `helpers.WriteArtifact` | `internal/core/app/output.go:148:15` |
| `mode.Suffix` | `internal/core/app/output.go:162:60` |
| `helpers.DiagramOutputPath` | `internal/core/app/output.go:166:16` |
| `helpers.WriteArtifact` | `internal/core/app/output.go:167:15` |
| `a.AnalyzeHallucinations` | `internal/core/app/output.go:194:17` |
| `a.AnalyzeProbableBridges` | `internal/core/app/output.go:196:22` |
| `a.resolveOutputRoot` | `internal/core/app/output.go:197:16` |
| `report.NewMarkdownGenerator().Generate` | `internal/core/app/output.go:202:14` |
| `report.NewMarkdownGenerator` | `internal/core/app/output.go:202:14` |
| `a.Graph.ModuleCount` | `internal/core/app/output.go:203:21` |
| `a.Graph.FileCount` | `internal/core/app/output.go:204:21` |
| `a.Config.Output.Report.IncludeMermaidEnabled` | `internal/core/app/output.go:219:25` |
| `helpers.WriteArtifact` | `internal/core/app/output.go:225:13` |
...
| `index.lineCol` | `internal/engine/secrets/detector.go:149:17` |
| `index.lineCol` | `internal/engine/secrets/detector.go:189:15` |
| `index.lineCol` | `internal/engine/secrets/detector.go:233:16` |
| `a.codeParser.IsSupportedPath` | `internal/core/app/analyzer.go:22:7` |
| `a.codeParser.IsTestFile` | `internal/core/app/analyzer.go:26:25` |
| `a.unresolvedMu.Lock` | `internal/core/app/analyzer.go:41:4` |
| `a.unresolvedMu.Unlock` | `internal/core/app/analyzer.go:43:4` |
| `a.unusedMu.Lock` | `internal/core/app/analyzer.go:44:4` |
| `a.unusedMu.Unlock` | `internal/core/app/analyzer.go:46:4` |
| `a.ProcessFile` | `internal/core/app/analyzer.go:50:13` |
| `a.Graph.DetectCycles` | `internal/core/app/analyzer.go:55:12` |
| `a.Graph.ModuleCount` | `internal/core/app/analyzer.go:67:29` |
| `a.Graph.ModuleCount` | `internal/core/app/analyzer.go:71:19` |
| `a.Graph.FileCount` | `internal/core/app/analyzer.go:72:19` |
| `a.SecretCount` | `internal/core/app/analyzer.go:73:19` |
| `resolver.NewResolver` | `internal/core/app/analyzer.go:83:10` |
| `resolver.NewResolver` | `internal/core/app/analyzer.go:94:10` |
| `res.WithBridgeResolutionConfig` | `internal/core/app/analyzer.go:95:3` |
| `a.resolverBridgeConfig` | `internal/core/app/analyzer.go:95:34` |
| `res.WithExplicitBridges` | `internal/core/app/analyzer.go:96:3` |
| `a.loadResolverBridges` | `internal/core/app/analyzer.go:96:27` |
| `resolver.NewResolver` | `internal/core/app/analyzer.go:101:10` |
| `res.WithBridgeResolutionConfig` | `internal/core/app/analyzer.go:102:3` |
| `a.resolverBridgeConfig` | `internal/core/app/analyzer.go:102:34` |
| `res.WithExplicitBridges` | `internal/core/app/analyzer.go:103:3` |
| `a.loadResolverBridges` | `internal/core/app/analyzer.go:103:27` |
| `res.WithBridgeResolutionConfig` | `internal/core/app/analyzer.go:107:2` |
| `a.resolverBridgeConfig` | `internal/core/app/analyzer.go:107:33` |
| `res.WithExplicitBridges` | `internal/core/app/analyzer.go:108:2` |
| `a.loadResolverBridges` | `internal/core/app/analyzer.go:108:26` |
| `helpers.UniqueScanRoots` | `internal/core/app/analyzer.go:137:46` |
| `a.newResolver` | `internal/core/app/analyzer.go:156:9` |
| `func() { _ = res.Close() }` | `internal/core/app/analyzer.go:157:8` |
| `res.Close` | `internal/core/app/analyzer.go:157:21` |
| `a.newResolver` | `internal/core/app/analyzer.go:164:9` |
| `func() { _ = res.Close() }` | `internal/core/app/analyzer.go:165:8` |
| `res.Close` | `internal/core/app/analyzer.go:165:21` |
| `a.cachedUnresolved` | `internal/core/app/analyzer.go:171:10` |
| `a.newResolver` | `internal/core/app/analyzer.go:179:9` |
| `func() { _ = res.Close() }` | `internal/core/app/analyzer.go:180:8` |
| `res.Close` | `internal/core/app/analyzer.go:180:21` |
| `a.unresolvedMu.Lock` | `internal/core/app/analyzer.go:183:2` |
| `a.Graph.GetFile` | `internal/core/app/analyzer.go:185:15` |
| `a.unresolvedMu.Unlock` | `internal/core/app/analyzer.go:195:2` |
| `a.cachedUnresolved` | `internal/core/app/analyzer.go:197:9` |
| `a.newResolver` | `internal/core/app/analyzer.go:201:9` |
| `func() { _ = res.Close() }` | `internal/core/app/analyzer.go:202:8` |
| `res.Close` | `internal/core/app/analyzer.go:202:21` |
| `a.currentGraphPaths` | `internal/core/app/analyzer.go:207:11` |
| `a.newResolver` | `internal/core/app/analyzer.go:208:9` |
| `func() { _ = res.Close() }` | `internal/core/app/analyzer.go:209:8` |
| `res.Close` | `internal/core/app/analyzer.go:209:21` |
| `res.FindUnusedImports` | `internal/core/app/analyzer.go:210:12` |
| `a.cachedUnused` | `internal/core/app/analyzer.go:217:10` |
| `a.newResolver` | `internal/core/app/analyzer.go:225:9` |
| `func() { _ = res.Close() }` | `internal/core/app/analyzer.go:226:8` |
| `res.Close` | `internal/core/app/analyzer.go:226:21` |
| `res.FindUnusedImports` | `internal/core/app/analyzer.go:227:13` |
| `a.unusedMu.Lock` | `internal/core/app/analyzer.go:229:2` |
| `a.Graph.GetFile` | `internal/core/app/analyzer.go:231:15` |
| `a.unusedMu.Unlock` | `internal/core/app/analyzer.go:241:2` |
| `a.cachedUnused` | `internal/core/app/analyzer.go:243:9` |
...
| `registry.New` | `internal/mcp/runtime/server.go:76:9` |
| `s.projectMu.RLock` | `internal/mcp/runtime/server.go:103:2` |
| `s.projectMu.RUnlock` | `internal/mcp/runtime/server.go:104:8` |
| `s.mu.Lock` | `internal/mcp/runtime/server.go:113:2` |
| `s.mu.Unlock` | `internal/mcp/runtime/server.go:115:3` |
| `s.mu.Unlock` | `internal/mcp/runtime/server.go:120:2` |
| `s.mu.Lock` | `internal/mcp/runtime/server.go:130:2` |
| `s.mu.Unlock` | `internal/mcp/runtime/server.go:132:2` |
| `s.mu.Lock` | `internal/mcp/runtime/server.go:138:2` |
| `s.mu.Unlock` | `internal/mcp/runtime/server.go:139:8` |
| `s.history.Close` | `internal/mcp/runtime/server.go:143:11` |
| `s.history.Close` | `internal/mcp/runtime/server.go:149:13` |
| `s.projectMu.RLock` | `internal/mcp/runtime/server.go:165:2` |
| `s.projectMu.RUnlock` | `internal/mcp/runtime/server.go:167:2` |
| `s.projectMu.RLock` | `internal/mcp/runtime/server.go:176:2` |
| `s.projectMu.RUnlock` | `internal/mcp/runtime/server.go:178:2` |
| `s.projectMu.RLock` | `internal/mcp/runtime/server.go:191:2` |
| `s.projectMu.RUnlock` | `internal/mcp/runtime/server.go:193:2` |
| `config.ResolvePaths` | `internal/mcp/runtime/server.go:215:16` |
| `config.ResolveRelative` | `internal/mcp/runtime/server.go:217:26` |
| `s.watchMu.Lock` | `internal/mcp/runtime/server.go:237:2` |
| `s.watchMu.Unlock` | `internal/mcp/runtime/server.go:239:3` |
| `s.watchMu.Unlock` | `internal/mcp/runtime/server.go:246:2` |
| `s.watchMu.Lock` | `internal/mcp/runtime/server.go:251:4` |
| `s.watchMu.Unlock` | `internal/mcp/runtime/server.go:253:4` |
| `s.registry.HandlerFor` | `internal/mcp/runtime/server.go:262:14` |
| `s.registry.HandlerFor` | `internal/mcp/runtime/server.go:282:17` |
| `contracts.OperationID` | `internal/mcp/openapi/filters.go:26:11` |
| `helpers.CompileGlobs` | `internal/core/app/app.go:97:28` |
| `helpers.CompileGlobs` | `internal/core/app/app.go:101:29` |
| `graph.NewLayerRuleEngine` | `internal/core/app/app.go:130:23` |
| `helpers.ArchitectureModelFromConfig` | `internal/core/app/app.go:130:48` |
...
| `helpers.UniqueScanRoots` | `internal/core/app/scanner.go:19:16` |
| `resolver.NewGoResolver` | `internal/core/app/scanner.go:24:8` |
| `r.FindGoMod` | `internal/core/app/scanner.go:25:13` |
| `r.GetModuleRoot` | `internal/core/app/scanner.go:26:36` |
| `a.ProcessFile` | `internal/core/app/scanner.go:44:13` |
| `g.Match` | `internal/core/app/scanner.go:84:9` |
| `a.codeParser.IsSupportedPath` | `internal/core/app/scanner.go:91:8` |
| `a.codeParser.IsTestFile` | `internal/core/app/scanner.go:96:26` |
| `g.Match` | `internal/core/app/scanner.go:101:8` |
| `a.Graph.GetFile` | `internal/core/app/scanner.go:119:21` |
| `g.Match` | `internal/core/app/scanner.go:184:6` |
| `g.Match` | `internal/core/app/scanner.go:193:7` |
...
| `s.app.Graph.FileCount` | `internal/core/app/service.go:63:18` |
| `s.app.Graph.ModuleCount` | `internal/core/app/service.go:68:17` |
| `s.app.Graph.DetectCycles` | `internal/core/app/service.go:100:12` |
| `s.app.Graph.ComputeModuleMetrics` | `internal/core/app/service.go:155:13` |
| `s.app.Graph.DetectCycles` | `internal/core/app/service.go:156:12` |
| `s.app.AnalyzeHallucinations` | `internal/core/app/service.go:157:16` |
| `s.app.AnalyzeUnusedImports` | `internal/core/app/service.go:158:12` |
| `s.app.ArchitectureViolations` | `internal/core/app/service.go:161:16` |
| `s.app.Graph.TopComplexity` | `internal/core/app/service.go:167:14` |
| `s.app.Graph.ModuleCount` | `internal/core/app/service.go:175:22` |
| `s.app.Graph.FileCount` | `internal/core/app/service.go:176:22` |
| `s.app.Graph.DetectCycles` | `internal/core/app/service.go:228:12` |
| `s.app.Graph.ComputeModuleMetrics` | `internal/core/app/service.go:234:13` |
| `s.app.ArchitectureViolations` | `internal/core/app/service.go:242:16` |
| `s.app.Graph.TopComplexity` | `internal/core/app/service.go:248:14` |
| `s.app.AnalyzeHallucinations` | `internal/core/app/service.go:249:20` |
| `s.app.AnalyzeUnusedImports` | `internal/core/app/service.go:250:19` |
| `s.app.Graph.FileCount` | `internal/core/app/service.go:253:19` |
| `s.app.Graph.ModuleCount` | `internal/core/app/service.go:254:19` |
| `s.app.Graph.DetectCycles` | `internal/core/app/service.go:335:12` |
| `s.app.Graph.ComputeModuleMetrics` | `internal/core/app/service.go:336:13` |
| `s.app.Graph.TopComplexity` | `internal/core/app/service.go:337:14` |
| `s.app.ArchitectureViolations` | `internal/core/app/service.go:338:16` |
| `s.app.AnalyzeUnusedImports` | `internal/core/app/service.go:339:12` |
| `r.checkModule` | `internal/engine/resolver/unresolved.go:11:5` |
| `r.graph.HasDefinitions` | `internal/engine/resolver/unresolved.go:46:8` |
| `r.checkModule` | `internal/engine/resolver/unresolved.go:47:9` |
| `r.graph.HasDefinitions` | `internal/engine/resolver/unresolved.go:63:9` |
| `r.checkModule` | `internal/engine/resolver/unresolved.go:64:10` |
| `r.graph.GetAllFiles` | `internal/engine/resolver/unresolved.go:86:11` |
| `r.findUnresolvedInFile` | `internal/engine/resolver/unresolved.go:89:35` |
| `r.graph.GetAllFiles` | `internal/engine/resolver/unresolved.go:98:11` |
| `r.findProbableBridgeReferencesInFile` | `internal/engine/resolver/unresolved.go:101:31` |
| `r.graph.GetFile` | `internal/engine/resolver/unresolved.go:117:15` |
| `r.findUnresolvedInFile` | `internal/engine/resolver/unresolved.go:121:35` |
| `r.graph.GetFile` | `internal/engine/resolver/unresolved.go:137:15` |
| `r.findProbableBridgeReferencesInFile` | `internal/engine/resolver/unresolved.go:141:31` |
| `r.resolveReferenceResult` | `internal/engine/resolver/unresolved.go:150:13` |
| `r.resolveReferenceResult` | `internal/engine/resolver/unresolved.go:167:13` |
...
| `r.graph.GetFile` | `internal/engine/resolver/unused_imports.go:18:15` |
...
| `s.mu.Lock` | `internal/mcp/transport/stdio.go:37:2` |
| `s.mu.Unlock` | `internal/mcp/transport/stdio.go:39:3` |
| `s.mu.Unlock` | `internal/mcp/transport/stdio.go:44:2` |
| `s.mu.Lock` | `internal/mcp/transport/stdio.go:47:3` |
| `s.mu.Unlock` | `internal/mcp/transport/stdio.go:49:3` |
| `s.mu.Lock` | `internal/mcp/transport/stdio.go:53:2` |
| `s.mu.Unlock` | `internal/mcp/transport/stdio.go:55:2` |
| `encoder.Encode` | `internal/mcp/transport/stdio.go:142:13` |
| `writer.Flush` | `internal/mcp/transport/stdio.go:145:13` |
| `encoder.Encode` | `internal/mcp/transport/stdio.go:259:12` |
| `writer.Flush` | `internal/mcp/transport/stdio.go:262:12` |
| `node.Kind` | `internal/engine/parser/universal.go:179:11` |
| `node.ChildCount` | `internal/engine/parser/universal.go:184:26` |
| `node.Child` | `internal/engine/parser/universal.go:185:11` |
| `ch.Kind` | `internal/engine/parser/universal.go:186:21` |
| `node.ChildCount` | `internal/engine/parser/universal.go:210:24` |
| `node.Child` | `internal/engine/parser/universal.go:211:9` |
| `ch.Kind` | `internal/engine/parser/universal.go:215:10` |
| `ch.Kind` | `internal/engine/parser/universal.go:238:10` |
| `node.StartPosition` | `internal/engine/parser/universal.go:258:14` |
| `node.ChildCount` | `internal/engine/parser/universal.go:260:24` |
| `node.Child` | `internal/engine/parser/universal.go:261:9` |
| `ch.Kind` | `internal/engine/parser/universal.go:265:10` |
| `node.StartPosition` | `internal/engine/parser/universal.go:288:14` |
| `node.ChildCount` | `internal/engine/parser/universal.go:291:24` |
| `node.Child` | `internal/engine/parser/universal.go:292:9` |
| `ch.Kind` | `internal/engine/parser/universal.go:296:10` |
| `node.ChildCount` | `internal/engine/parser/universal.go:319:24` |
| `node.Child` | `internal/engine/parser/universal.go:320:9` |
| `ch.Kind` | `internal/engine/parser/universal.go:324:10` |
| `node.Kind` | `internal/engine/parser/universal.go:343:10` |
| `node.StartPosition` | `internal/engine/parser/universal.go:357:17` |
| `node.StartPosition` | `internal/engine/parser/universal.go:358:17` |
| `node.ChildCount` | `internal/engine/parser/universal.go:374:24` |
| `node.Child` | `internal/engine/parser/universal.go:375:17` |
| `node.ChildByFieldName` | `internal/engine/parser/universal.go:388:11` |
| `node.ChildByFieldName` | `internal/engine/parser/universal.go:395:13` |
| `node.ChildByFieldName` | `internal/engine/parser/universal.go:400:12` |
| `node.ChildCount` | `internal/engine/parser/universal.go:407:24` |
| `node.Child` | `internal/engine/parser/universal.go:408:12` |
| `child.Kind` | `internal/engine/parser/universal.go:412:11` |
| `node.Kind` | `internal/engine/parser/universal.go:423:10` |
| `node.ChildCount` | `internal/engine/parser/universal.go:424:5` |
| `node.StartByte` | `internal/engine/parser/universal.go:438:11` |
| `node.EndByte` | `internal/engine/parser/universal.go:439:9` |
...
| `g.mu.Lock` | `internal/engine/graph/graph.go:76:2` |
| `g.mu.Unlock` | `internal/engine/graph/graph.go:77:8` |
| `g.mu.Lock` | `internal/engine/graph/graph.go:82:2` |
| `g.mu.Unlock` | `internal/engine/graph/graph.go:83:8` |
| `g.fileCache.Get` | `internal/engine/graph/graph.go:87:18` |
| `g.removeFileLocked` | `internal/engine/graph/graph.go:88:3` |
| `g.fileCache.Put` | `internal/engine/graph/graph.go:91:2` |
| `g.imports` | `internal/engine/graph/graph.go:150:3` |
| `g.importedBy` | `internal/engine/graph/graph.go:155:3` |
| `g.mu.Lock` | `internal/engine/graph/graph.go:160:2` |
| `g.mu.Unlock` | `internal/engine/graph/graph.go:161:8` |
| `g.removeFileLocked` | `internal/engine/graph/graph.go:162:2` |
| `g.fileCache.Get` | `internal/engine/graph/graph.go:197:17` |
| `g.imports` | `internal/engine/graph/graph.go:212:7` |
| `g.importedBy` | `internal/engine/graph/graph.go:216:7` |
| `g.mu.RLock` | `internal/engine/graph/graph.go:237:2` |
| `g.mu.RUnlock` | `internal/engine/graph/graph.go:238:8` |
| `g.mu.RLock` | `internal/engine/graph/graph.go:247:2` |
| `g.mu.RUnlock` | `internal/engine/graph/graph.go:248:8` |
| `g.mu.RLock` | `internal/engine/graph/graph.go:258:2` |
| `g.mu.RUnlock` | `internal/engine/graph/graph.go:259:8` |
| `g.mu.RLock` | `internal/engine/graph/graph.go:264:2` |
| `g.mu.RUnlock` | `internal/engine/graph/graph.go:265:8` |
| `g.mu.RLock` | `internal/engine/graph/graph.go:278:2` |
| `g.mu.RUnlock` | `internal/engine/graph/graph.go:279:8` |
| `g.mu.RLock` | `internal/engine/graph/graph.go:285:2` |
| `g.mu.RUnlock` | `internal/engine/graph/graph.go:286:8` |
| `g.mu.RLock` | `internal/engine/graph/graph.go:291:2` |
| `g.fileCache.Get` | `internal/engine/graph/graph.go:292:11` |
| `g.mu.RUnlock` | `internal/engine/graph/graph.go:294:2` |
| `g.mu.Lock` | `internal/engine/graph/graph.go:304:4` |
| `g.fileCache.Put` | `internal/engine/graph/graph.go:305:4` |
| `g.mu.Unlock` | `internal/engine/graph/graph.go:306:4` |
...
| `g.mu.RUnlock` | `internal/engine/graph/graph.go:329:8` |
| `g.mu.RLock` | `internal/engine/graph/graph.go:342:2` |
| `g.mu.RUnlock` | `internal/engine/graph/graph.go:343:8` |
| `g.mu.Lock` | `internal/engine/graph/graph.go:444:2` |
| `g.mu.Unlock` | `internal/engine/graph/graph.go:445:8` |
| `g.mu.Lock` | `internal/engine/graph/graph.go:452:2` |
| `g.mu.Unlock` | `internal/engine/graph/graph.go:453:8` |
...
| `db.Close` | `internal/engine/graph/symbol_store.go:49:7` |
| `db.Close` | `internal/engine/graph/symbol_store.go:54:7` |
| `s.db.Begin` | `internal/engine/graph/symbol_store.go:93:13` |
| `tx.Exec` | `internal/engine/graph/symbol_store.go:99:16` |
| `tx.Rollback` | `internal/engine/graph/symbol_store.go:100:8` |
| `tx.Commit` | `internal/engine/graph/symbol_store.go:103:13` |
| `tx.Rollback` | `internal/engine/graph/symbol_store.go:110:7` |
| `tx.Rollback` | `internal/engine/graph/symbol_store.go:115:8` |
| `tx.Rollback` | `internal/engine/graph/symbol_store.go:119:8` |
| `tx.Commit` | `internal/engine/graph/symbol_store.go:124:12` |
| `s.db.Begin` | `internal/engine/graph/symbol_store.go:134:13` |
| `tx.Rollback` | `internal/engine/graph/symbol_store.go:139:7` |
| `tx.Rollback` | `internal/engine/graph/symbol_store.go:143:7` |
| `tx.Commit` | `internal/engine/graph/symbol_store.go:146:12` |
| `s.db.Begin` | `internal/engine/graph/symbol_store.go:156:13` |
| `tx.Rollback` | `internal/engine/graph/symbol_store.go:161:7` |
| `tx.Exec` | `internal/engine/graph/symbol_store.go:164:15` |
| `tx.Rollback` | `internal/engine/graph/symbol_store.go:165:7` |
| `tx.Commit` | `internal/engine/graph/symbol_store.go:168:12` |
| `tx.Exec` | `internal/engine/graph/symbol_store.go:198:11` |
| `s.db.Begin` | `internal/engine/graph/symbol_store.go:209:13` |
| `tx.Exec` | `internal/engine/graph/symbol_store.go:214:16` |
| `tx.Rollback` | `internal/engine/graph/symbol_store.go:215:8` |
| `tx.Exec` | `internal/engine/graph/symbol_store.go:218:16` |
| `tx.Rollback` | `internal/engine/graph/symbol_store.go:219:8` |
| `tx.Rollback` | `internal/engine/graph/symbol_store.go:224:8` |
| `tx.Exec` | `internal/engine/graph/symbol_store.go:235:16` |
| `tx.Rollback` | `internal/engine/graph/symbol_store.go:236:8` |
| `tx.Commit` | `internal/engine/graph/symbol_store.go:240:12` |
| `s.lookupRows` | `internal/engine/graph/symbol_store.go:254:9` |
| `s.lookupRows` | `internal/engine/graph/symbol_store.go:285:9` |
| `db.Exec` | `internal/engine/graph/symbol_store.go:395:13` |
| `db.Exec` | `internal/engine/graph/symbol_store.go:450:13` |
| `tx.Exec` | `internal/engine/graph/symbol_store.go:477:15` |
| `tx.Exec` | `internal/engine/graph/symbol_store.go:492:15` |
| `tx.Exec` | `internal/engine/graph/symbol_store.go:499:15` |
...
| --- | --- | --- | --- | --- | --- |
| `go` | `circular/internal/mcp/contracts` | `` | `` | `medium` | `internal/mcp/transport/stdio.go:5:0` |
...
| `go` | `circular/internal/core/ports` | `` | `` | `medium` | `internal/core/app/service.go:5:0` |
| `go` | `circular/internal/engine/graph` | `` | `` | `medium` | `internal/core/app/service.go:8:0` |
| `go` | `circular/internal/engine/parser` | `` | `` | `medium` | `internal/core/app/service.go:9:0` |
| `go` | `circular/internal/data/history` | `` | `` | `medium` | `internal/core/ports/ports.go:4:0` |
| `go` | `circular/internal/engine/graph` | `` | `` | `medium` | `internal/core/ports/ports.go:6:0` |
| `go` | `circular/internal/engine/parser` | `` | `` | `medium` | `internal/core/ports/ports.go:7:0` |
...
| `go` | `syscall` | `` | `` | `medium` | `internal/ui/cli/runtime.go:22:0` |
...
| `go` | `circular/internal/core/ports` | `` | `` | `medium` | `internal/engine/secrets/adapter.go:4:0` |
| `go` | `circular/internal/engine/parser` | `` | `` | `medium` | `internal/engine/secrets/adapter.go:5:0` |
